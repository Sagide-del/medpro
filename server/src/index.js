...
import assignmentWorkflowRoutes from './routes/assignmentWorkflow.js';
import simulationEngineRoutes from './routes/simulationEngine.js';
...
import publishedContentRoutes from './routes/publishedContent.js';
...
app.use('/api/assignment-workflow', assignmentWorkflowRoutes);
app.use('/api/simulations', simulationEngineRoutes);
...
app.use('/api/published-content', publishedContentRoutes);
